...
class SheltersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelter" do
    assert_difference("Shelter.count") do
      post shelters_url, params: { shelter: { address: @shelter.address, animalNumber: @shelter.animalNumber, cagesNumber: @shelter.cagesNumber, description: @shelter.description } }
    end
  ...
  test "should update shelter" do
    patch shelter_url(@shelter), params: { shelter: { address: @shelter.address, animalNumber: @shelter.animalNumber, cagesNumber: @shelter.cagesNumber, description: @shelter.description } }
